        ...
        <div>
            <div className='flex flex-col min-h-screen w-full gap-5 py-5 px-2'>
                ...
                <div className='mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 bg-white rounded-lg'>
                    <h2 className='text-4xl font-bold tracking-tight text-gray-900 pt-5 mb-5 text-left'>Name: {user.name ? user.name : 'GUEST'}</h2>
                    <h4 className='text-xl font-bold tracking-tight text-red-600 mb-0 text-left'>Email address: {user.email}</h4>
                    <h4 className='border-b border-gray-200 text-xl font-bold tracking-tight text-red-600 mb-2 pb-4 text-left'>Phone number: {user.addresses.length > 0 ? `${user.addresses[0].phone}` : 'Not added yet'}</h4>
                    {user.role === 'admin' && <h4 className='border-b border-gray-200 text-xl font-bold tracking-tight text-green-600 mb-2 pb-4 text-left'>Role: {user.role}</h4>}
                    ...
                    {user.addresses.length > 0 && <h4 className='border-t border-gray-200 text-xl font-bold tracking-tight text-blue-600 mt-2 pt-3 text-left'>Saved Addresses</h4>}
