        ...
        <div>
            <form noValidate action="#" method="POST" onSubmit={handleSubmit((data) => {
                ...
                if (params.id) {
                    ...
                    console.log("BHAI YE AAYA PRODUCT: ", product);
                    dispatch(updateProductAsync(product));
                    reset();
                }
                else {
                ...
                <div className="space-y-12 bg-white p-10 rounded-lg">
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        {selectedProduct.deleted ? <h2 className="text-red-500 text-lg mt-6 font-bold">This product is deleted</h2> : <h2 className="text-green-500 text-lg mt-6 font-bold">This product exists</h2>}
