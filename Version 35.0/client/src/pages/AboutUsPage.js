        ...
        <div>
            <Navbar>
                <div className='w-full h-full'>
                    <div className="bg-white relative flex items-center rounded-lg justify-center overflow-hidden z-50 ">
                                ...
                                <div className=" relative ">
                                    ...
                                    <div className="lg:max-w-xl lg:pr-5 relative z-40">
                                        ...
                                        <div className="mt-10 flex flex-col items-center md:flex-row">
                                            <Link
                                                to="/"
                                                className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-[#F7B030] px-6 font-medium tracking-wide text-black hover:text-white shadow-md transition hover:bg-[#0096FF] focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                                            >
                                                Visit our website
                                            </Link>
                                            <a
