...
const productSchema = new Schema({
    ...
    discountPercentage: { type: Number, min: [0, 'Discount percentage of product cannot be less than 0'],  max: [0, 'Discount percentage of product cannot be gearter than 90'] },
