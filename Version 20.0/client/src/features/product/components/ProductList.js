...
import { selectAllProducts, fetchProductsByFilterAsync, selectTotalItems, selectBrands, selectCategories, fetchAllCategoriesAsync, fetchAllBrandsAsync, selectProductStatus } from '../productSlice';
  ...
  const handleFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      if (newFilter[section.id]) {
        console.log('newFilter[section.id]: ', newFilter[section.id]);
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  <ProductGrid products={products} loadingStatus={loadingStatus} />
                </div>
              </div>
            </section>
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products.map((product) => (
            <Link to={`/product-detail/${product.id}`} key={product.id}>
              <div className="group relative border border-1 border-gray-400 p-3 rounded-md">
...
//                 aria-current="page"
//                 className={`relative z-10 inline-flex items-center ${page === index + 1 ? 'bg-indigo-600 text-white' : 'bg-white text-gray-500'} px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer border-2`}
//               >
//                 {index + 1}
//               </div>
//             )
