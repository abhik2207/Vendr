...
export default function AdminProductList() {
  ...
  const handleSort = (e, option) => {
    // -- My method -- 
    // const sortObject = option.order === 'desc' ? '-' + option.sort : option.sort;
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  <div className='px-8'>
                    <Link to='/admin/product-form' type="button" className="rounded-md w-full bg-green-600 px-3 py-2 my-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                      + Add new product
                    </Link>
                  </div>
          ...
          {products.map((product) => (
            <div key={product.id}>
              <Link to={`/product-detail/${product.id}`}>
                <div className="group relative border border-1 mb-3 border-gray-400 p-3 rounded-md">
                  ...
                  <div className="mt-4 flex justify-between">
                    ...
                    <div className='flex flex-col items-center'>
                      <p className="text-md font-medium text-gray-900">${product.price - Math.round(product.price * product.discountPercentage / 100)}</p>
              ...
              <div className='mb-2'>
                <Link to={`/admin/product-form/edit/${product.id}`} type="button" className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                  Edit product
                </Link>
              </div>
            </div>
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            ...
            to{' '}
            <span className="font-medium">{page * ITEMS_PER_PAGE > totalItems ? totalItems : page * ITEMS_PER_PAGE}</span>{' '}
            of{' '}
          ...
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {Array.from({ length: totalPages }).map((el, index) => (
              <div
                ...
                aria-current="page"
                className={`relative z-10 inline-flex items-center ${page === index + 1 ? 'bg-indigo-600 text-white' : 'bg-white text-gray-500'} px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer`}
              >
                {index + 1}
              </div>
            )
