...
const addresses = [
    ...
    },
    {
        ...
        state: "Haryana",
        phone: 9876543210,
        email: 'gagansingh@gmail.com'
    },
    {
        name: "Nikhil Kumar",
        housenumber: "House No. 7",
        locality: "Madirapur",
        city: "Bangalore",
        pincode: 110054,
        state: "Karnataka",
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                    <div className='lg:col-span-3'>
                        <form className='bg-white px-5 my-6 py-6 rounded-lg'>
                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <ul className="divide-y divide-gray-300">
                                        {addresses.map((address) => (
                                            <li key={address.phone} className="flex justify-between gap-x-6 py-5">
                                                <div className="flex min-w-0 gap-x-4">
                                                    ...
                                                    <div className="min-w-0 flex-auto">
                                                        ...
                                                        <p className="mt-1 truncate text-xs leading-5 text-gray-500">Email: {address.phone}</p>
                                                    </div>
                                                </div>
                    ...
                    <div className='lg:col-span-2'>
                        <div className='mx-auto m-6 max-w-7xl px-4 sm:px-0 lg:px-0 bg-white rounded-lg'>
                            <h2 className='text-3xl font-bold tracking-tight text-gray-900 mb-2 pt-5 text-center'>Cart</h2>
                            <div className="border-t border-gray-300 px-4 py-6 sm:px-6">
                                <div className="flow-root">
                                    <ul className="-my-6 divide-y divide-gray-400">
                                                ...
                                                <div className="ml-4 flex flex-1 flex-col">
                                                    ...
                                                    <div className="flex flex-1 items-end justify-between text-sm">
                                                        <div className="text-gray-500">
                                                            <label htmlFor="quantity" className="inline mr-5 text-sm font-medium leading-6 text-gray-900">Qty {product.quantity}</label>
                                                            <select name="quantity" id="quantity" className='text-sm'>
